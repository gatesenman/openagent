      ...
      {steps.map((step) => (
        ...
        >
          ...
          <div className="px-4 py-2 border-t border-[var(--border)] flex items-center justify-between text-xs text-[var(--text-secondary)]">
            <span>
              <svg className="w-3 h-3 inline mr-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
    ...
    <div className="max-w-3xl mx-auto">
      <div className="rounded-lg border border-[var(--border)] bg-[var(--bg-secondary)] p-6">
        ...
        <p className="mt-4 text-xs text-[var(--text-secondary)]">
          <svg className="w-3 h-3 inline mr-1 text-[var(--success)]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="20 6 9 17 4 12"/></svg>无循环依赖
        </p>
      </div>
    </div>
  );
